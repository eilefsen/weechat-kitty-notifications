...
def prnt_datetime_tags(
    buffer: str, date: int, date_usec: int, tags: str, message: str
) -> int:
...
def prnt_y_datetime_tags(
    buffer: str, y: int, date: int, date_usec: int, tags: str, message: str
) -> int:
...
def hook_completion(
    completion_item: str, description: str, callback: str, callback_data: str
) -> str:
...
def hook_timer(
    interval: int, align_second: int, max_calls: int, callback: str, callback_data: str
) -> str:
...
def hook_url(
    url: str, options: Dict[str, str], timeout: int, callback: str, callback_data: str
) -> str:
...
def nicklist_add_group(
    buffer: str, parent_group: str, name: str, color: str, visible: int
) -> str:
...
def bar_new(
    ...
    condition: str,
    position: str,
    filling_top_bottom: str,
    filling_left_right: str,
    size: str,
    size_max: str,
    color_fg: str,
    color_delim: str,
    color_bg: str,
    color_bg_inactive: str,
    separator: str,
    items: str,
) -> str:
...
def completion_list_add(
    completion: str, word: str, nick_completion: int, where: str
) -> int:
...
def hdata_compare(
    hdata: str, pointer1: str, pointer2: str, name: str, case_sensitive: int
) -> int:
